...
class fold:
    ...
    def __init__(self,
        ...
        if type is None:
            ...
            self.type = 'naieve'
        elif  not isinstance(type, str) or not type.lower() in ['naieve', 'dimensionality', 'composite']:
            message = ('Unfolding method not understood.\n'
                       '\nCurrent options are:\n'
                       u'    Na\xefeve (naieve) - Matrix Inversion, Correction Factors\n'
